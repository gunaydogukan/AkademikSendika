        ...
        <div id="container1">
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="paylasimlar_icerik" HeaderText="paylasimlar_icerik" SortExpression="paylasimlar_icerik" />
                    <asp:BoundField DataField="kullanici_isim" HeaderText="kullanici_isim" SortExpression="kullanici_isim" />
                </Columns>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:AkademikSendika_DbConnectionString %>" ProviderName="<%$ ConnectionStrings:AkademikSendika_DbConnectionString.ProviderName %>" SelectCommand="makale_goster" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
        </div>
    </form>
</body>
</html>
